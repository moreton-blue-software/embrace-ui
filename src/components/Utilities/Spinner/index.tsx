...
export default function Spinner({ width, height }: TSpinnerProps) {
  return (
    <Box width={width} height={height} component="div">
      <svg
        ...
        <circle cx="50" cy="50" r="10" fill="#f47e60">
          <animate
            ...
            values="0;0;10;10;10"
            keySplines="0 0.5 0.5 1;0 0.5 0.5 1;0 0.5 0.5 1;0 0.5 0.5 1"
            begin="-0.3846153846153846s"></animate>
          <animate
            attributeName="cx"
            repeatCount="indefinite"
            dur="1.5384615384615383s"
        ...
        <circle cx="84" cy="50" r="10" fill="#f8b26a">
          <animate
            ...
            values="0;0;10;10;10"
            keySplines="0 0.5 0.5 1;0 0.5 0.5 1;0 0.5 0.5 1;0 0.5 0.5 1"
            begin="-0.7692307692307692s"></animate>
          <animate
            attributeName="cx"
            repeatCount="indefinite"
            dur="1.5384615384615383s"
        ...
        <circle cx="16" cy="50" r="10" fill="#abbd81">
          <animate
            ...
            values="0;0;10;10;10"
            keySplines="0 0.5 0.5 1;0 0.5 0.5 1;0 0.5 0.5 1;0 0.5 0.5 1"
            begin="-1.1538461538461537s"></animate>
          <animate
            attributeName="cx"
            repeatCount="indefinite"
            dur="1.5384615384615383s"
